//Shannon P. Drake
//CIS 1030
//Programming Assignment #4: Vic's Sweetshop Redux
...
public class Cheesecake {
	...
	double grandTotal = 0;
	int cheeseCakesOrdered = 0;
	int cheeseCakesProcessed = 0; 
	
	//Taking Order
	System.out.println("How many cheesecakes would you like to order?")
	cheeseCakesOrdered = scnr.nextInt();
	System.out.println("Okay, great, that's " + cheeseCakesOrdered + " cheesecakes.");

	
	//Hopefully this is half as clever as I think it is
	
	while (cheeseCakesProcessed <= cheeseCakesOrdered) {
	//Getting Size
...
if (userFlavor == 1){
	...
	System.out.println("I'm sorry, I don't understand. Please enter a choice between 1 and 5.")
}

//Calculations and final output
individualTotal = (userSize * userDouble); 

//I found this to fix the formatting issues
String individualTotalAsString = String.format("%.2f", individualTotal);
	...
	cheeseCakesProcessed++;


	}
	System.out.println("Your grand total for " + cheeseCakesOrdered + " cheesecakes is $" + grandTotal);
	}
}
